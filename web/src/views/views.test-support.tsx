...
export const realityDashboard = () => {
  ...
  data.apps = [{ key: "vastora-official/3x-ui", sourceId: "vastora-official", fetchedAt: "2026-08-18T00:00:00Z", manifestSha256: "a".repeat(64), app: { id: "3x-ui", version: "3.7.0", packageRevision: 1, runtime: { kind: "docker", version: 1 }, name: { en: "3x-ui", "zh-CN": "3x-ui" }, description: { en: "Proxy management", "zh-CN": "代理管理" }, hostAccess: true, config: [] } }];
