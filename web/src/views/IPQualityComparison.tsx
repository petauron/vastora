...
function ComparisonPanel({ language, nodeId, nodes = [], allowedNodeIds, onSelect }: Props) {
  ...
  const provisional = candidates.filter((value) => value.assessment.status !== "complete");
