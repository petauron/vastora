...
export function SetupWizard(props: SetupWizardProps) {
  ...
  useEffect(() => {
    writeSetupDraft({ step: step === 1 ? 1 : 2, name, timezone, domainSuffix, mode, agentConnectUrl, headscaleMode, headscaleUrl, publicAddress, gatewayAddress, natConfirmed, publishFixedEndpoint, fixedEndpointConfirmed });
  }, [step, name, timezone, domainSuffix, mode, agentConnectUrl, headscaleMode, headscaleUrl, publicAddress, gatewayAddress, natConfirmed, publishFixedEndpoint, fixedEndpointConfirmed]);
