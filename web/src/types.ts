...
export type ThreeXUIClientInbound = { id: number; name: string; displayName?: string; applicationId?: string; nodeId?: string; nodeName?: string; connectHostname?: string; sniHostname?: string };
