...
validateCatalog(JSON.parse(validCatalogBytes));
...
console.log(
  `validated catalog v0.1 contracts: ${1 + additionalValidFixtures.length} valid, ${invalidFixtures.length} invalid, exact-byte signature and tamper case`,
);
