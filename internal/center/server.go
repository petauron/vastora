...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("GET /api/v1/three-x-ui/client-landing", s.requireAuth(false, s.handleLandingClientGrants))
	mux.HandleFunc("GET /api/v1/three-x-ui/client-landing/mode", s.requireAuth(false, s.handleLandingClientMode))
	mux.HandleFunc("PUT /api/v1/three-x-ui/client-landing/mode", s.requireAuth(true, s.handleLandingClientMode))
	mux.HandleFunc("PUT /api/v1/three-x-ui/client-landing", s.requireAuth(true, s.handleLandingClientGrants))
	...
	mux.HandleFunc("PUT /api/v1/applications/{id}/landing", s.requireAuth(true, s.handleConfigureLandingProxy))
