...
CREATE TABLE application_commands_v70 (
			id TEXT PRIMARY KEY,
...
INSERT INTO application_commands_v70(rowid,id,application_id,site_id,display_name,agent_id,gateway_node_id,kind,input_json,result_json,result_secret_id,state,reconciliation_required,reconciliation_requested,attempt,lease_expires_at,error,created_at,updated_at)
...
ALTER TABLE application_commands_v70 RENAME TO application_commands;
