-- +goose Up
ALTER TABLE publications ADD COLUMN certificate_secret_id TEXT REFERENCES secrets(id) ON DELETE SET NULL;
ALTER TABLE publications ADD COLUMN certificate_not_after TEXT NOT NULL DEFAULT '';
...
CREATE TABLE application_commands_v9 (
    id TEXT PRIMARY KEY,
...
INSERT INTO application_commands_v9 SELECT * FROM application_commands;
DROP TABLE application_commands;
ALTER TABLE application_commands_v9 RENAME TO application_commands;
